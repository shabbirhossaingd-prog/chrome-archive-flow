...
export const Route = createFileRoute("/collection")({
  head: () => ({
    meta: [
      { title: "DROP 001 — AFTERDARK — ZZERKOFF New Collection" },
      {
        name: "description",
        content:
          "DROP 001 — AFTERDARK. A study of metal, shadow and distortion. The newest ZZERKOFF objects.",
      },
      { property: "og:title", content: "DROP 001 — AFTERDARK — ZZERKOFF" },
      {
        property: "og:description",
        content: "A study of metal, shadow and distortion. Objects for those who choose identity.",
      },
    ],
  }),
...
function CollectionPage() {
  ...
  const drop = products.filter((p) => p.new_collection);
        ...
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <Reveal delay={160}>
            <div className="space-y-6 font-editorial text-lg leading-relaxed text-muted-foreground sm:text-xl">
              <p>A study of metal, shadow and distortion.</p>
              <p>Objects designed for those who choose identity over conformity.</p>
            </div>
            <Link
              to="/shop"
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12">
            <ProductGrid
              products={drop}
              loading={isLoading}
              empty="Drop 001 objects are being finished."
            />
          </div>
        </div>
      </section>
