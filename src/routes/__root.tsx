    ...
    <div className="relative isolate flex min-h-screen items-center justify-center overflow-hidden bg-background px-5 text-center">
      ...
      <div className="relative z-10 max-w-lg">
        <img
          ...
          width={220}
          height={220}
          className="mx-auto w-28 mix-blend-lighten contrast-125"
        />
        <span className="mt-8 block text-[9px] uppercase tracking-[0.48em] text-muted-foreground">
          ZZ / 404
        </span>
        <h1 className="chrome-text mt-5 font-display text-4xl tracking-[0.14em] sm:text-6xl">
          LOST OBJECT
        </h1>
        ...
        <Link
          to="/"
          className="mt-9 inline-flex rounded-full border border-chrome/50 bg-white/[0.04] px-8 py-5 text-[9px] uppercase tracking-[0.38em] text-foreground transition-colors hover:bg-white/[0.08]"
        >
          Return home
        </Link>
      </div>
  ...
  return (
    <div className="relative isolate flex min-h-screen items-center justify-center overflow-hidden bg-background px-5 text-center">
      ...
      <div className="relative z-10 max-w-lg">
        ...
        <h1 className="chrome-text mt-5 font-display text-3xl tracking-[0.14em] sm:text-5xl">
          SIGNAL INTERRUPTED
        </h1>
        <p className="mx-auto mt-6 max-w-md font-editorial text-lg text-muted-foreground">
          This page could not load correctly. Retry the signal or return home.
        </p>
        ...
        <div className="mt-9 flex flex-wrap justify-center gap-3">
          ...
          <a
            href="/"
            className="rounded-full border border-border/60 px-7 py-5 text-[9px] uppercase tracking-[0.34em] text-muted-foreground transition-colors hover:text-foreground"
          >
            Go home
          </a>
        </div>
    ...
    head: () => ({
      meta: [
        ...
        },
        {
          ...
          content:
            "Unisex chrome accessories. Vintage metal, gothic form, underground culture.",
        },
