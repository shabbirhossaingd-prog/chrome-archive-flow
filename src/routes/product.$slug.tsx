...
export const Route = createFileRoute("/product/$slug")({
  ...
  head: ({ loaderData, params }) => {
    const product =
      (loaderData ?? null) as Product | null;
    ...
    const description =
      ...
      `${pretty(
        params.slug,
      )} — a ZZERKOFF object for the afterdark.`;
    ...
    const image = absoluteSmartImageUrl(
...
function ProductPage() {
  const product =
    Route.useLoaderData() as Product | null;
...

      {
        ...
        itemListElement: [
...

          {
            ...
            item:
              `${SITE_URL}/shop/${encodeURIComponent(
                product.category,
              )}`,
          },
        ...
        >
          ...
          <div className="mt-10 space-y-3">
            {soldOut ? (
              ...
              <>
                {/* Existing Place Order behavior unchanged */}
